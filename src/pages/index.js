      ...
      <section className="main">
        ...
        <section className="side-info">
          ...
          <span className="basic-info">
            ...
            <p>
              Proposals move through stages at TC39 meetings, which are held
              every <a href="https://github.com/tc39/agendas/">two months</a>,
              and the <a href="https://github.com/tc39/tc39-notes/">Notes</a>{' '}
              are made public.
            </p>
          </span>
          <span className="basic-info">
            ...
            <p>
              There are many opportunities to get involved on an individual
              level. Check out our
              <a href="https://github.com/tc39/proposals/blob/master/CONTRIBUTING.md">
                Contributor Documentation
              </a>{' '}
              and our guides to learn more. To get involved with the committee
              on an organizational level, read our
